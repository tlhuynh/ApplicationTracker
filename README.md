...
- **Excel import** — upload `.xlsx` files to bulk import records, with row-level validation (required fields, enum matching, date parsing, URL format) and error reporting
